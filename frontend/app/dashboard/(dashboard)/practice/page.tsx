...
export default function LifeWordsPage() {
  ...
  const startSessionWithCategory = async (category: string) => {
    ...
    try {
      ...
      router.push(`/dashboard/practice/session/${sessionData.session.id}`)
  ...
  const handleStartQuestionSession = async () => {
    ...
    try {
      ...
      router.push(`/dashboard/practice/questions/session/${sessionData.session.id}`)
  ...
  const handleStartInformationSession = async () => {
    ...
    try {
      ...
      router.push(`/dashboard/practice/information/session/${sessionData.session.id}`)
        ...
        {needsSetup ? (
            ...
            {(status?.total_count || 0) === 0 ? (
              ...
              <>
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-6">
                  <p className="text-blue-800 text-lg">
                    ...
                    <Link href="/dashboard/practice/how-it-works" className="underline hover:text-blue-600">
                      How It Works guide
                    </Link>{' '}
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
                  ...
                  <Link
                    href="/dashboard/practice/how-it-works"
              ...
              <>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
                  ...
                  <Link
                    href="/dashboard/practice/messages"
          ...
          <div className="bg-green-50 border-2 border-green-200 rounded-lg p-8 mb-6">
            ...
            {!infoStatus?.can_start_session && infoStatus && (
              <div className="mt-4 text-center">
                <p className="text-gray-600 text-base">
                  ...
                  <Link href="/dashboard/practice/my-information" className="text-teal-600 underline hover:text-teal-700">
                    My Info
                  </Link>{' '}
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8 gap-3">
              <Link
                href="/dashboard/practice/quick-add"
              ...
              <Link
                href="/dashboard/practice/progress"
              ...
              <Link
                href="/dashboard/practice/my-information"
